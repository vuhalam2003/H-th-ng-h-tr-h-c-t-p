<aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item"> --}}
            ...
            {{-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('db') }}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('user.id', ['id' => $user->id]) }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thông tin sinh viên</p>
                </a>
              </li>
              {{-- <li class="nav-item">
                <a href="{{ route('khoa_hoc.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <div class="sidebar-custom">
      ...
      <a href="{{route('logout')}}" class="btn btn-secondary hide-on-collapse pos-right">Thoát</a>
    </div>
    <!-- /.sidebar-custom -->
  </aside>